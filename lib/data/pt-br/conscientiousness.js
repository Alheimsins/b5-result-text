...
obrigação. Aqueles com alta pontuação têm um forte senso de moral. Pessoas com pontuação baixa 
consideram regras, contratos e regulamentações exageradas, podendo ser vistos como não confiáveis 
ou até mesmo irresponsáveis.`
    },
    {
      facet: 4,
      title: 'Realização-Esforço',
      text: `Indivíduos com alta pontuação, têm disposição para trabalhar duro e são motivados 
por metas (se esforçam para alcançar a excelência). Gostam de se sentir reconhecidos e tem objetivos 
claros na vida. Às vezes a busca por perfeição os tornam 'workaholic', obcecados com o trabalho. 
Pessoas que pontuam pouco nessa competência se sentem realizados quando cumprem determinada tarefa com 
...
vezes não conseguem completar tarefas, mesmo as que eles queiram muito finalizar.`
    },
    {
      facet: 6,
      title: 'Cautela',
      text: `Tendem a refletir cuidadosamente sobre as decisões antes de agir. Os que obtém
alta pontuação, pensam nas possibilidades e consequências das ações antes de tomar uma decisão. 
Já os que pontuam baixo normalmente falam/fazem a primeira coisa que vem à mente sem pensar muito 
nas consequências das suas palavras e ações.`
    }
  ]
}
