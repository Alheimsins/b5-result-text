module.exports = {
  ...
  description: `Einstaklingar sem skora hátt á þessum þætti er líklegri til að forðast aðstæður sem geta átt í för með sér líkamlega hættu og eru yfirleitt næmari fyrir streitu en aðrir. Þeir sækja yfirleitt í mikla nánd, samúð og tilfinningalegan stuðning frá öðrum. Einstaklingar sem skora hátt á þættinum geta átt það til að telja að þeir hafi enga stjórn á hlutum eða aðstæðum og forðast því yfirleitt streituvaldandi aðstæður. Þar sem þeir eru líklegri til að upplifa sterkar tilfinningar en aðrir eru þeir yfirleitt taldir vera miklar tilfinningaverur sem eru næmir fyrir tilfinningum sínum og annarra.<br/><br/>
