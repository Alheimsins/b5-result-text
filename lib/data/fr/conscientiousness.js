  ...
  'facets': [
    {
      ...
      'text': "L'auto-efficacité décrit votre confiance en votre capacité à accomplir les choses. Avec un score bas, vous ne vous sentez pas éfficace et ressentez un sentiment de perte de contrôle dans ce que vous entreprenez. Avec un score dans la moyenne, vous connaissez vos limites et arrivez à estimer vos capacités à accomplir une tâche assez justement. Avec un score haut, vous pensez avoir les capacités de controle ou de gestion nécessaires pour accomplir avec succès n'importe quoi."
    },
    {
      'facet': 2,
      'title': 'Organisation',
    ...
    },
    {
      'facet': 3,
      'title': 'Respect',
      'text': "Le respect représente votre sentiment de devoir et d'obligation. Avec un score bas, vous trouvez les contrats, régles et réglementations trop contraignantes. Vous etes vu comme quelqu'un de peu fiable ou irresponsable. Avec un score dans la moyenne, les règles et contraintes ne vous dérangent pas. Avec un score haut, vous avez un grand sens moral et obligataire."
    },
    {
      'facet': 4,
      'title': 'Persévérance',
      'text': "Avec un score bas, vous vous contentez de faire le minimum. Les autres vous voient comme un paresseux. Avec un score dans la moyenne, vous savez être ambitieux quand il le faut. Avec un score haut, vous faites tout votre possible pour atteindre l'excellence. Vous continuez pour être reconnu pour avoir atteint de nobles objectifs. Vous donnez un grand sens à votre vie, mais un score extreme sera également trop determiné voire obsédé par son but."
    },
    {
      'facet': 5,
