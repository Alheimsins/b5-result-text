module.exports = {
  ...
  'description': "Freud utilisait originellement le terme \"névrose\" pour décrire une situation mentalement bouleversante, émotionnellement blessante et une incapacité à surmonter les situations normales de la vie. Il a suggéré que chacun montre des signes de névrose, mais que nous en souffrons à différents dégrés et de façons differentes. Aujourd'hui le névrosisme se référe à la gestion des situations émotionnellement négatives.    <br /><br />    Ceux ayant un score haut éprouvent principalement un sentiment spécifique négatif comme l'anxiété, la colère ou la dépression, mais probalement plusieurs de ces dernières.    <br /><br />    Les individus au score haut sont émotionnellement réactifs. Ils répondent émotionnellement aux événements qui normalement n'affecteraient pas les autres, et ils réagissent plus intensément que la normale. Ils interpretent les situations normales comme menaçantes, et minorent les frustrations comme le désespoir.    <br /><br />    Leurs réactions émotionnelles négatives ont tendance à persister exceptionnellement sur de longue periode, ce qui signifie qu'ils se sentent mal. Ces problèmes dans le régulations des émotions peuvent être diminués par des capacités de penséés claires, prendre des décisions et surmonter efficacement le stress",
  'results': [
    {
      'score': 'low',
