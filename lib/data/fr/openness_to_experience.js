module.exports = {
  ...
  'description': "Les personnes ouvertes d'esprit sont intellectuellement curieuses, aprécient l'art et sont sensibles à la beauté. Ils tendent à être perçus comme des gens proches et en phase avec leurs émotions. Ils agissent de façon non conventionnelle. Les intellectuels ont typiquement un score haut en ouverture d'esprit, en conscéquence, ce facteur est aussi appelé Culture ou Intellect.    <br /><br />    Néanmoins, l'intellect est probalement l'aspect le plus important de l'ouverture d'esprit. Ce score n'est que peu corrélé aux années d'experience ou au test d'intelligence standard.    <br /><br />    Une autre caracteristique de l'ouverture cognitive est la facilité d'abstration des concepts plutôt que la limitation aux faits. Ramener à un individu, cette capacité peut se traduire par des formes de pensées orientées vers les mathématiques, la logique, la géometrie, l'art, les métaphores verbales, la musique ou bien d'autres formes d'arts.    <br /><br />    Les individus présentant un score bas tendent à avoir des centres d'intérêts restreints. Ils prefèreront des reflexions simples et claires plutôt que complexes, ambigues ou subtiles. Ils voient les reflexions artistiques et scientifiques comme obscures et complexes à mettre en oeuvre. Ils préféreront la routine à la nouveauté. Ils sont conservateurs et resistants aux changements.    <br /><br />    L'ouverture d'esprit est souvent présentée comme étant une preuve de maturité et plus saine pour l'esprit. Cependant ces systemes de pensées présentent des avantages et des inconvénients en fonction de l'environnement de l'individu. Par exemple, un score haut aidera les professeurs, à l'inverse un score bas aidera les policiers ou les commerciaux.",
  'results': [
    {
      'score': 'low',
      'text': "Votre score bas cela indique que vous aimez refléchir en terme simple. Votre entourage vous décrit comme quelqu'un de conservateur, pratique et terre à terre"
    },
    {
      'score': 'neutral',
      'text': "Votre score dans la moyenne cela indique que vous aimez les traditions mais également que vous n'êtes pas contre les nouvelles choses. Votre mode de pensée est plus simple que complexe. Votre entourage vous voit comme quelqu'un de bien éduqué mais pas non plus un intellectuel."
    },
    {
      'score': 'high',
      'text': 'Votre score haut cela indique que vous aimez tenter de nouvelles experiences, varier les plaisirs et le changement en règle générale. Vous êtes curieux, imaginatif et créatif'
    }
  ],
  'facets': [
    {
