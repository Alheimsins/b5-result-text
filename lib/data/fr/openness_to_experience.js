...
//      text: `Your score on Openness to Experience is low, indicating you like to think in plain and simple terms. Others describe you as down-to-earth, practical, and conservative.`
      text: 'Votre score d\'ouverture d\'esprit est bas, cela indique que vous aimez refléchir en terme simple. Votre entourage vous décrit comme quelqu\'un de conservateur, pratique et/ou terre à terre'
    },
    {
...
//      text: `Your score on Openness to Experience is average, indicating you enjoy tradition but are willing to try new things. Your thinking is neither simple nor complex. To others you appear to be a well-educated person but not an intellectual.`
      text: 'Votre score d\'ouverture d\'esprit est dans la moyenne, cela indique que vous aimez les traditions mais également que vous n\'etes pas contre les nouvelles choses. Votre mode de penser est plus simple que complexe. Votre entrouge vous vois comme quelqu\'un de bien éduqué mais pas non plus un intellectuel.'
    },
    {
...
//      text: `Your score on Openness to Experience is high, indicating you enjoy novelty, variety, and change. You are curious, imaginative, and creative.`
      text: 'Votre score d\'ouverture d\'esprit est haut, cela indique que vous aimez, tenter de nouvelles experiences, varier les plaisir et le changement en règle générale. Vous êtes curieux, imaginatif et créatif'
    }
  ],
  facets: [
    {
