module.exports = {
  ...
  description: `Freud benutzte ursprünglich den Begriff Neurose um 
Zustand der mentalen Verzweiflung, emotionaler Leidens, und der 
Unfähigkeit die normalen Ansprüche des Lebens effizient zu bewältigen zu 
beschreiben. Er behauptet dass jeder ein paar Zeichen von Neurose zeigt, 
...
meist intensiver als bei anderen Menschen. Sie intepretieren gewöhnliche 
...
Probleme bei der emotionalen Regulation reduziert bei einem Neurotiker 
die Fähigkeit klar zu denken, Entscheidungen zu treffen und Stress 
...
sehen dich als sensitiv und emotional.`
    }
  ],
  facets: [
    {
...
Schwermütigkeit, und Entmutigun zu fühlen. Personen mit hoher Punktzahl 
in Depression fehlt Energy und haben Schwierigkeiten Aktivitäten zu 
...
Gefühle nicht zu haben.`
    },
    {
      ...
      text: `Selbstbewusste Individuen ist es wichtig, was andere über 
...
sind leicht und oft beschämt. Ihre Angst, dass andere sie kritisieren 
oder über sie her ziehen sind oft übertrieben und unrealistisch, aber 
ihre Ungeschicklichkeit und Unwohlsein machen diese Ängste zu einer 
selbt erfüllenden Prophezeihung. Menschen mit niedriger Punktzahl 
hingegen leiden nicht unter von diesem irrtümlichen Eindruck, dass jeder 
