module.exports = {
  ...
  description: `Impulse sind nicht grundsätzlich falsch; gelegentlich ist es 
notwendig wegen Zeitbeschränkungen mit einem spontanen Entschluss zu reagieren,
und mit dem ersten Impuls zu reagieren ist eine effektive Reaktion. Außerdem
...
es kann ebenfalls zu Rachegelüsten gegenüber dem Täter der impusliven 
Handlungen führen. Ein weiteres Problem sind die ungewollten langfristingen
Konsequenzen, auch wenn vorerst sofortige Belohnungen entstehen. Zum Beispiel
den Verlust eines Jobs nach übermäßigem Sozialisieren, der Zusammenbruch einer
...
<br /><br />
Impulsives Verhalten, auch wenn dieses nicht wirklich schädlich ist, reduzieren
die Effektivität der Person auf mehreren signifikanten Weisen. Das impulsive 
handeln verhindert es alternative Herangehensweisen an ein Problem, welche
...
Lebensformen unterscheided, ist die Fähigkeit über zukünftige Konsequenzen nach
zu denken bevor nach einem Impuls gehandelt wird. Intelligente Aktivitäten 
erfordern das Reflektieren über Langzeitziele, das Planen und Organisieren der
Schritte zu diesem Zeil, sowie das Durchhaltevermögen für das Ziel gegenüber
kurzzeitigen Impulsen. Die Idee, dass Inteligenz das kontrollieren von Impulsen
...
Gewissenhaftigkeit sind offensichtlich. Gewisenhafte Individuen vermeiden 
...
Perfektionisten und Workaholics sein. Desweiteren könnten extrem gewissenhafte
...
viele kurzzeite Vergnügungen und werden niemals als spießig angesehen.`,
  results: [
    {
      score: 'low',
      text: `Deine Punktzahl in Gewissenhaftigkeit ist niedrig, was darauf 
hinweist, dass du für den Moment lebst und tust was für dich im Moment gut
...
bedeutet, dass du ziemlich zuverlässig, organisiert bist und dich selbst
beherrscht.`
    },
    {
      score: 'high',
...
sehen dich als zuverlässig und hart arbeitend an.`
    }
  ],
  facets: [
    {
      facet: 1,
      title: 'Kompetenz',
      text: `Kompetenz beschreibt die Selbsicherheit in die eigene Fähigkeit
...
Erfolg zu erzielen. Menschen mit niedrigere Punktzahl fühlen sich uneffektiv,
...
unorganisiert und zerstreut zu sein.`
    },
    {
      ...
      text: `Diese Skala reflektiert die Stärke der Pfichtauffassung einer 
Person. Jene die eine hohe Punktzahl in dieser Skala erzielen haben ein starkes
...
hält sie auf der Spur für ihre hochgesteckten Ziele. Sie haben oft einen
konkreten Lebensweg, aber extrem hohe Punktzahlen sind möglicherweise zu 
zielgerichtet und besessen mit ihrer Arbeit. Menschen mit niedriger Punktzahl
genügt es ihre Arbeit mit minimalstem Aufwand zu erledigen und können von
...
konsequent zu arbeiten bis diese erledigt sind. Leute mit hoher Selbstdisziplin
...
sie ihre Aufgaben zu erledigen, auch wenn sie das durchaus möchten.`
    },
    {
      facet: 6,
      title: 'Besonnenheit',
...
Mennschen mit niedriger Punktzahl handeln oft nach dem ersten Gedanken ohne 
über Alternativen und möglichen Konsequenzen dieser Alternativen nach zu 
denken.`
    }
  ]
}
