module.exports = {
  ...
  shortDescription: 'Verträglichkeit zeigt die individuellen Unterschiede für die Bereitschaft zur Kooperation für die Soziale Harmonie. Menschen mit start ausgeprägter Verträglichkeit ist es wichtig sich mit anderen zu verstehen.'
  description: `Daher sind sie rücksichtsvoll, freundlich, großzügig, 
hilfsbereit und zu Kompromissen bereit für das Wohl anderer.  
Verständliche Personen haben ebenfalls eine optimistische Sichtweise der 
menschlichen Natur. Sie glauben, dass Menschen ehrlich, anständig, und 
vertrauenswürdig sind. <br /><br /> 
Unverträgliche Individuen legen ihr eigenes Interesse über das soziale Wohl.
...
Auf der anderen Hand ist Verträglichkeit nicht in Situationen hilfreich in 
denen harte oder absolut objektive Entscheidungen gefällt werden müssen. 
Unverträgliche Menschen sind exzellente Wissenschaftler, Kritiker und Soldaten.`,
  results: [
    {
      score: 'low',
...
Interesse für die Bedürfnisse anderer. Du wirst als angenehm, sympatisch
...
Vertrauen sehen andere als egoistisch, hinterhältig und potentiell gefährlich.`
    },
    {
      facet: 2,
      title: 'Moral',
      text: `Menschen mit hohen Punkten auf dieser Skala sehen es als nicht
nötig auf Manipulation oder Täuschung zu greifen wenn sie es mit anderen 
Menschen zu tun haben und wirken aufrichtig, offe und ehrlich. Menschen mit
...
in Not zu helfen. Altruistische Menschen emfinden es als eine Form von 
