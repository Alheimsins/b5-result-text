...
"Ja!" oder "Auf geht's" auf neue Chancen für aufregende Aktivitäten. In 
Gruppen haben sie gerne das Wort, setzen sich durch, und ziehen die 
...
lediglich weniger Stimulation als ein Extroviertierter und sind gerne 
...
Verträglichkeit nicht auf Menschen zu gehen, ist aber ein geselliger Typ 
wenn sie/er von anderen angesprochen werden.`
  results: [
    {
      score: 'low',
      text: `Deine Punktzahl in Extraversion ist niedrig, was darauf 
hinweist, dass du introviertiert, zurückhaltend und leise bist. Du magst 
...
aber sie neigen dazu nicht auf Leute zu zugehen und werden von anderen 
...
die Gesellschaft anderer Menschen nicht, aber ihr Bedürfniss nach 
Privatssphäre und Zeit für sich selbst ist viel größer als das der Leute 
...
langsameres und müßigeres, entspannteres Leben.`
    },
    {
      ...
      text: `Menschen mit hoher Punktzahl in dieser Skala sind oft 
gelangweilt ohne ein hohes Stimulationsniveau. Sie lieben grelle Lichter 
...
und Tumult überfordert und lehnen dazu nicht nach dem Nervenkitzel zu 
suchen.`
    },
    {
      facet: 6,
...
Personen mit hoher Punktzhal auf dieser Skala empfinden typischerweise 
oft zahlreiche positive Gefühle, einschließlich von Glücklichkeit, 
Enthusiasmus, Optimismus und Freude. Menschen mit niedriger Punktzahl 
sind oft nicht so eine Neigung für diese energetische Munterkeit.`
    }
  ]
}
