module.exports = {
  ...
  shortDescription: 'Offenheit für Erfahrungen beschreibt eine geistige Dimension die zwischen einfallsreichen, kreativen Menschen und bodenständigen, konventionellen Menschen unterscheided.'
...
üblicherweise eine hohe Punktzahl in Offenheut für Erfahrungen; Infolgedessen
wird dieser Faktor auch Kultur oder Intellekt genannt. <br /> <br />
Nichtsdestotrotz wird Intellekt besser als einer der Askepte von Offenheit für
Erfahrungen betrachtet. Punktzahlen in Offenheit für Erfahrungen sind nur 
bedingt mit der Bildung oder Ergebnissen von standardisierten Intelligenztests
verbunden. <br /><br />
Eine andere Charakteristic der geistig offenen Stils ist eine Leichtigkeit für
abstraktes Denken weit entfernt von konkreten Erfahrungen. Je nachdem was genau
diese spezielle Fähigkeit des Inidviduums ist, prägt sie sich in der 
Form vom
Mathematic, logischem oder geometrischem Denken, kunstvoller oder 
metaphorischer Nutzung der Sprache, musikalischen Kompositionen oder 
Auftritten, oder eine der vielen visuellen oder darstellenden Künsten.
<br /><br />
...
Unkomplizierte, und Offensichtliche über das Komplexe, Mehrdeutige, und 
Subtile. Sie könnten Kunst und Wissenschaft gegenüber misstrauisch sein 
und die Bemühungen als abstrus und ohne praktischen Nutzen sehen. 
Verschlossene Menschen ziehen Gewohnheit vor Neuheiten; sie sind 
konservativ und resistenz gegenüber Veränderungen.
<br /><br />
...
Der intellektuelle Stil der offenen Person könnte sich für einen 
Professoren brauchbar sein, während Forschungen zeigten, dass 
geschlossene Denkweisen zu überlegender Arbeitsleistungen in der 
...
durschschnittlich, was darauf schließen lässt, dass du gerne 
...
Person, aber nicht einem Intellektuellen.`
    },
    {
      score: 'high',
...
sind mehr an Fakten als auf Fantasie interessiert.`
    },
    {
      facet: 2,
...
Kunst.`
    },
    {
      facet: 3,
      title: 'Emotionalität',
      text: `Personen mit hoher Emotionaliätt haben eine gute Kontrolle 
und Warhnehmung ihrer eigenen Gefühle. Menschen mit niedriger Punktzahl 
sind weniger bewusst über ihre Gefühle und tendieren dazu diese nicht 
offen zu zeigen.`
    },
    {
      facet: 4,
...
ist. Menschen mit niedriger Punktzahl neigen zu Unwohlheit bei 
...
sind unvoreingenommen gegnüber neuen und ungewöhnlichen Ideen, und mögen 
es über intellektuelle Probleme zu diskutieren. Ihnen gefallen Rätsel, 
Puzzel und Denkaufgaben. Menschen mit niedriger Punktzahl bevorzugen es 
mit Menschen oder Dingen statt Ideen zu arbeiten. Sie sehen 
intellektuele Übungen als eine Zeitverschwendung. Intellekt sollte nicht 
mit Intelligenz verwechselt werden. Intellekt ist eine Denkweise, keine 
Fähigkeit, auch wenn Menschen mit hoher Punktzahl in standardisierten 
Intelligenztests meist besser abschneiden als Menschen mit niedriger 
Punktzahl.`
    },
    {
      facet: 6,
...
Bereitschafft um die Authorität, Konvention und traditionelle Werte in 
Frage zu stellen. In seiner extremsten Form zeigt psychologischer 
Liberalismus absolute Feindseeligkeit gegenüber Regeln, Sympatie für 
Gesetzesbrecher, und eine Liebe für Unklarheit, Chaos und Unordnung. 
Psychologische Konservative bevorzugen die Sicherheut und Stabilität 
