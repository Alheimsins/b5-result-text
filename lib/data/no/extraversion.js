module.exports = {
  ...
  description: `De ekstroverte liker å være sammen med mennesker, er fulle av energi, og opplever ofte positive følelser. De pleier å være entusiastiske, handlingsorienterte individer som liker å si "Ja!" eller "La oss sette i gang!" når det åpner seg muligheter for å oppleve noe spennende. De liker å snakke i grupper, hevde seg selv og rette oppmerksomhet mot seg selv. De introverte mangler livligheten, energien og aktivitesnivået til de ekstroverte. De er ofte stille, nedstemte, forsiktige og lite engasjert i den sosiale verden. Deres mangel på sosialt engasjement bør ikke tolkes som reserverthet eller depresjon; den introverte trenger bare mindre stimulering enn den ekstroverte og foretrekker å være alene. Uavhengigheten og reservasjonen til den introverte er noen ganger feilaktig sett på som uvennlighet eller arroganse. I realiteten så vil en introvert som skårer høyt på medmennesklighetsfaktoren ikke søke andre bevisst, men synes det er ganske greit hvis andre søker deres selskap.`,
  results: [
    {
      score: 'low',
