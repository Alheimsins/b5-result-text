module.exports = {
  ...
  description: `De er derfor hensynsfulle, vennlige og villige til å finne kompromisser dersom det er interessekonflikter. Medmenneskelige individer har også et optimistisk syn på menneskenaturen. De tror at mennesker i bunn og grunn er ærlige, redelige og til å stole på. Lite medmenneskelige individer setter egne interesser over det å komme overens med andre. De er generelt ikke så opptatt av andres ve og vel, og vil derfor ikke strekke seg langt for andre mennesker. Noen ganger er det deres skepsis når det gjelder andres motiver som forårsaker deres mistenksomhet, uvennlighet og mangel på samarbeidsvilje. Medmenneskelighet er svært fordelaktig for å bli populær og for å fortsette å være det. Medmenneskelige individer er bedre likt enn de som er lite medmenneskelig. Men medmenneskelighet er ingen nyttig egenskap i situasjoner der det kreves at man tar tøffe og helt objektive beslutninger. Lite medmenneskelige individer kan bli dyktige vitenskapsmenn, kritikere eller soldater.`,
  results: [
    {
      score: 'low',
